		...
		<table class="table table-bordered">
			...
			<c:forEach var="dto" items="${list }" varStatus="i">
				<tr>
					...
					<td align="center"><a href="detail?num=${dto.num }"><img
							alt="" src="../save/${dto.carphoto }"></a><br>
						${dto.carname }</td>
					<td align="center">
						<div style="background-color: ${dto.carcolor}" class="box"></div>
					</td>
					<td align="center"><fmt:formatNumber value="${dto.carprice }"
							type="currency" /></td>
					<td align="center">${dto.carguip }</td>
					<td><fmt:formatDate value="${dto.guipday }"
